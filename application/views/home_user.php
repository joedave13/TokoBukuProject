			...
			<div class="collapse navbar-collapse" id="navbarColor02">
			  	<ul class="navbar-nav mr-auto">
				    <li class="nav-item active">
				      <a class="nav-link" href="<?php echo base_url('Home/user'); ?>">Home <span class="sr-only">(current)</span></a>
				    </li>
				    <!--<li class="nav-item">
				    ...
				    <li class="nav-item dropdown">
				    	<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
       					...
       					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
       						<a class="dropdown-item" href="<?php echo base_url('Buku/index_user'); ?>">Data Buku</a>
       					</div>
				    </li>
			  	</ul>
		...
		<div class="container">
			<div class="wrapper">
				...
				body{
			        ...
			        .jumbotron {
			            background: 40%;             /* Transparent background */
			        }
				...
				<p class="lead">
					Selamat datang di toko buku kami. Selamat berbelanja!
				</p>
				<hr class="my-4">
				<p>
					Silahkan lihat koleksi buku kami
				</p>
				<p class="lead">
					<a class="btn btn-primary btn-lg" href="<?php echo base_url('Buku/index_user'); ?>">
			...
			<?php $no = 1; foreach ($buku as $key) { ?>
				<div class="card text-black bg-dark mb-3" style="max-width: 50rem;">
				  	...
				  	<div class="card-body">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text"><?php echo $key->nama_penerbit; ?></p>
							</div>
						</div>
			  		</div>
			  		<center>
			  			<img width="200" height="300" src="<?php echo base_url('foto/'.$key->foto); ?>">
			  		</center>
				</div>
			<?php $no++; } ?>
		</center>
