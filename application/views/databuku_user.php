...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<table class="table table-hover table-inverse" id="tabel-buku">
				...
				<tbody>
					<?php $no = 1; foreach ($buku as $key) { ?>
						<tr>
							...
							<td>
								<a class="btn btn-primary" href="<?php echo base_url('Buku/detail_user/'.$key->id) ?>">
									<span class="oi oi-magnifying-glass"></span> Detail
								</a>
								<a class="btn btn-block-md btn-secondary" href="<?php echo base_url('Beli/index/'.$key->id) ?>">
