...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<div class="wrapper" >
			<center><h1><b>Data Buku</b></h1></center>
			<center><hr class="my-4"></center>
			<center>Berikut adalah daftar koleksi buku yang disediakan di sistem kami</center>

			<br><br>

			<a class="btn btn-success" href="<?php echo base_url('Buku/input'); ?>">
				<span class="oi oi-plus"></span> Tambah Buku
			</a>

			<br><br>

			<table class="table table-hover table-inverse" id="table-buku">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-outline-primary" href="<?php echo base_url('Buku/detail/'.$key->id) ?>">
								<span class="oi oi-magnifying-glass"></span> Detail
							</a>
							&nbsp;&nbsp;
							<a class="btn btn-outline-warning" href="<?php echo base_url('Buku/update/'.$key->id) ?>">
								<span class="oi oi-loop"></span> Update
							</a>
							&nbsp;&nbsp;
							<a class="btn btn-outline-danger" href="<?php echo base_url('Buku/delete/'.$key->id) ?>">
